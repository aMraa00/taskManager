...
const Dashboard = () => {
  ...
  const prepareChartData = (data) => {
    ...
    const taskDistributionData = [
      ...
      { status: "Явагдаж буй", count: taskDistribution?.InProgress || 0 },
  ...
  return (
    <DashboardLayout activeMenu="Хэрэглэгчийн самбар">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-4 md:my-6">
        ...
        <div>
          <div className="card">
            <div className="flex items-center justify-between">
              <h5 className="font-medium">Даалгаврын зэрэглэлүүд</h5>
            </div>
        ...
        <div className="md:col-span-2">
          <div className="card">
            <div className="flex items-center justify-between ">
              <h5 className="text-lg">Сүүлийн даалгаврууд</h5>

              <button className="card-btn" onClick={onSeeMore}>
                Бүгдийг харах <LuArrowRight className="text-base" />
              </button>
            </div>
